...
export default function ExpandableGalaxyCard() {
              ...
              <div>
                <div className="flex justify-between items-start p-4">
                  ...
                  <motion.a
                    ...
                    href={active.ctaLink}
                    className="px-4 py-3 text-sm rounded-full font-bold bg-white text-black hover:bg-gray-200 transition-colors"
                  >
                    {active.ctaText}
                  </motion.a>
                </div>
      ...
      <ul className="max-w-2xl mx-auto w-full gap-4 flex justify-center">
        {cards.map((card, index) => (
          <motion.div
            ...
            className="p-4 flex flex-col md:flex-row justify-between items-center bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl cursor-pointer backdrop-blur-md transition-colors w-full md:w-auto min-w-[300px]"
          >
            ...
            <motion.button
              ...
              className="px-4 py-2 text-sm rounded-full font-bold bg-white text-black hover:bg-gray-200 mt-4 md:mt-0"
            >
              {card.ctaText}
            </motion.button>
          </motion.div>
...
const cards = [
  {
    ...
    title: "Enter Galaxy",
    src: "https://images.unsplash.com/photo-1462331940025-496dfbfc7564?q=80&w=2011&auto=format&fit=crop",
    ctaText: "Sign In",
    ctaLink: "/sign-in",
    content: () => {
      return (
